...
import Ordinary from "views/Shareholder/Ordinary/components/Ordinary";
import Total from "views/Shareholder/Ordinary/components/Total";
import Voice from "views/Shareholder/Ordinary/components/Voice";
export default function UserReports() {
  ...
  return (
    parseInt(data.ordinaryData.value) === 0 ? (
      <Box>
        <Text color="#000" mt="12rem" fontSize="xxx-large">You Don't Have Ordinary Share!!</Text>
      </Box>
    ) : (
